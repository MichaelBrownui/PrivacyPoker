...
contract PrivacyPoker is SepoliaConfig {
    ...
    uint32 public constant ANTE_AMOUNT = 10; // 盲注金额
    ...
    function joinGame() external payable gameInState(GameState.WaitingForPlayers) {
        ...
        require(msg.value >= ANTE_AMOUNT * 1 ether, "Insufficient ante amount");
        ...
        // 初始化玩家余额
        playerBalances[msg.sender] = FHE.asEuint32(uint32(msg.value / 1 ether));
